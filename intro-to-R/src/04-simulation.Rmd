...
A very useful function for simulation is `replicate` that let's us repeat expressions a number of times. We will see later on another more general approach to this idea of _repeating_ things through loops. Consider the sampling distribution of the statistic, for instance:
