...
Depending on the context, it will probably make sense to wrap this operations in a function. At the end of the day, the only thing that will change in different calculations of a cummulative sum is the vector it operates over, so we can _parametrize_ over that vector:
